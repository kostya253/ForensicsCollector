...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Provider "Forensics Collector Provider" event count 5
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

// Provider GUID = a81a60b5-b6c0-47b0-a009-7e5414298da5
EXTERN_C __declspec(selectany) const GUID ForesicsCollector = {0xa81a60b5, 0xb6c0, 0x47b0, {0xa0, 0x09, 0x7e, 0x54, 0x14, 0x29, 0x8d, 0xa5}};

#ifndef ForesicsCollector_Traits
#define ForesicsCollector_Traits NULL
#endif // ForesicsCollector_Traits

//
// Event Descriptors
//
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR RegOp = {0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0};
#define RegOp_value 0x1
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR FileOp = {0x2, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0};
#define FileOp_value 0x2
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR CreateOp = {0x3, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0};
#define CreateOp_value 0x3
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR LoadOp = {0x4, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0};
#define LoadOp_value 0x4
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR ObjectOp = {0x5, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0};
#define ObjectOp_value 0x5
...
//
EXTERN_C __declspec(selectany) DECLSPEC_CACHEALIGN ULONG Forensics_Collector_ProviderEnableBits[1];
EXTERN_C __declspec(selectany) const ULONGLONG Forensics_Collector_ProviderKeywords[1] = {0x0};
EXTERN_C __declspec(selectany) const unsigned char Forensics_Collector_ProviderLevels[1] = {0};

//
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT ForesicsCollector_Context = {0, (ULONG_PTR)ForesicsCollector_Traits, 0, 0, 0, 0, 0, 0, 1, Forensics_Collector_ProviderEnableBits, Forensics_Collector_ProviderKeywords, Forensics_Collector_ProviderLevels};

//
// Provider REGHANDLE
//
#define Forensics_Collector_ProviderHandle (ForesicsCollector_Context.RegistrationHandle)
...
//
#define ForesicsCollector_EventWriteActivity 0
...
//
#ifndef EventRegisterForensics_Collector_Provider
#define EventRegisterForensics_Collector_Provider() McGenEventRegister(&ForesicsCollector, McGenControlCallbackV2, &ForesicsCollector_Context, &Forensics_Collector_ProviderHandle)
#endif
...
//
#ifndef EventRegisterByGuidForensics_Collector_Provider
#define EventRegisterByGuidForensics_Collector_Provider(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &ForesicsCollector_Context, &Forensics_Collector_ProviderHandle)
#endif
...
//
#ifndef EventUnregisterForensics_Collector_Provider
#define EventUnregisterForensics_Collector_Provider() McGenEventUnregister(&Forensics_Collector_ProviderHandle)
#endif
...
// - Caller allocates memory, e.g. pContext = malloc(sizeof(McGenContext_Forensics_Collector_Provider));
// - Caller registers the provider, e.g. EventRegisterForensics_Collector_Provider_ForContext(pContext);
// - Caller writes events, e.g. EventWriteMyEvent_ForContext(pContext, ...);
// - Caller unregisters, e.g. EventUnregisterForensics_Collector_Provider_ForContext(pContext);
// - Caller frees memory, e.g. free(pContext);
//

typedef struct tagMcGenContext_Forensics_Collector_Provider {
    // The fields of this structure are subject to change and should
    // not be accessed directly. To access the provider's REGHANDLE,
    // use Forensics_Collector_ProviderHandle_ForContext(pContext).
    MCGEN_TRACE_CONTEXT Context;
    ULONG EnableBits[1];
} McGenContext_Forensics_Collector_Provider;

#define EventRegisterForensics_Collector_Provider_ForContext(pContext)             _mcgen_PASTE2(_mcgen_RegisterForContext_Forensics_Collector_Provider_, MCGEN_EVENTREGISTER)(&ForesicsCollector, pContext)
#define EventRegisterByGuidForensics_Collector_Provider_ForContext(Guid, pContext) _mcgen_PASTE2(_mcgen_RegisterForContext_Forensics_Collector_Provider_, MCGEN_EVENTREGISTER)(&(Guid), pContext)
#define EventUnregisterForensics_Collector_Provider_ForContext(pContext)           McGenEventUnregister(&(pContext)->Context.RegistrationHandle)

//
// Provider REGHANDLE for caller-allocated context.
//
#define Forensics_Collector_ProviderHandle_ForContext(pContext) ((pContext)->Context.RegistrationHandle)

// This function is for use by MC-generated code and should not be used directly.
// Initialize and register the caller-allocated context.
__inline
ULONG __stdcall
_mcgen_PASTE2(_mcgen_RegisterForContext_Forensics_Collector_Provider_, MCGEN_EVENTREGISTER)(
    _In_ LPCGUID pProviderId,
    _Out_ McGenContext_Forensics_Collector_Provider* pContext)
{
    RtlZeroMemory(pContext, sizeof(*pContext));
    pContext->Context.Logger = (ULONG_PTR)ForesicsCollector_Traits;
    pContext->Context.EnableBitsCount = 1;
    pContext->Context.EnableBitMask = pContext->EnableBits;
    pContext->Context.EnableKeyWords = Forensics_Collector_ProviderKeywords;
    pContext->Context.EnableLevel = Forensics_Collector_ProviderLevels;
...
FORCEINLINE
_Ret_ McGenContext_Forensics_Collector_Provider*
_mcgen_CheckContextType_Forensics_Collector_Provider(_In_ McGenContext_Forensics_Collector_Provider* pContext)
{
    return pContext;
}
...
//
// Enablement check macro for event "RegOp"
//
#define EventEnabledRegOp() _mcgen_EVENT_BIT_SET(Forensics_Collector_ProviderEnableBits, 0)
#define EventEnabledRegOp_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_Forensics_Collector_Provider(pContext)->EnableBits, 0)

//
// Event write macros for event "RegOp"
//
#define EventWriteRegOp(ProcessId, ThreadId, NotifyClassName, NotifyClass) \
        MCGEN_EVENT_ENABLED(RegOp) \
        ? _mcgen_TEMPLATE_FOR_RegOp(&ForesicsCollector_Context, &RegOp, ProcessId, ThreadId, NotifyClassName, NotifyClass) : 0
#define EventWriteRegOp_AssumeEnabled(ProcessId, ThreadId, NotifyClassName, NotifyClass) \
        _mcgen_TEMPLATE_FOR_RegOp(&ForesicsCollector_Context, &RegOp, ProcessId, ThreadId, NotifyClassName, NotifyClass)
#define EventWriteRegOp_ForContext(pContext, ProcessId, ThreadId, NotifyClassName, NotifyClass) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, RegOp) \
        ? _mcgen_TEMPLATE_FOR_RegOp(&(pContext)->Context, &RegOp, ProcessId, ThreadId, NotifyClassName, NotifyClass) : 0
#define EventWriteRegOp_ForContextAssumeEnabled(pContext, ProcessId, ThreadId, NotifyClassName, NotifyClass) \
        _mcgen_TEMPLATE_FOR_RegOp(&_mcgen_CheckContextType_Forensics_Collector_Provider(pContext)->Context, &RegOp, ProcessId, ThreadId, NotifyClassName, NotifyClass)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_RegOp _mcgen_PASTE2(McTemplateU0xxzx_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "FileOp"
//
#define EventEnabledFileOp() _mcgen_EVENT_BIT_SET(Forensics_Collector_ProviderEnableBits, 0)
#define EventEnabledFileOp_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_Forensics_Collector_Provider(pContext)->EnableBits, 0)

//
// Event write macros for event "FileOp"
//
#define EventWriteFileOp(ProcessId, ThreadId, FileName) \
        MCGEN_EVENT_ENABLED(FileOp) \
        ? _mcgen_TEMPLATE_FOR_FileOp(&ForesicsCollector_Context, &FileOp, ProcessId, ThreadId, FileName) : 0
#define EventWriteFileOp_AssumeEnabled(ProcessId, ThreadId, FileName) \
        _mcgen_TEMPLATE_FOR_FileOp(&ForesicsCollector_Context, &FileOp, ProcessId, ThreadId, FileName)
#define EventWriteFileOp_ForContext(pContext, ProcessId, ThreadId, FileName) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, FileOp) \
        ? _mcgen_TEMPLATE_FOR_FileOp(&(pContext)->Context, &FileOp, ProcessId, ThreadId, FileName) : 0
#define EventWriteFileOp_ForContextAssumeEnabled(pContext, ProcessId, ThreadId, FileName) \
        _mcgen_TEMPLATE_FOR_FileOp(&_mcgen_CheckContextType_Forensics_Collector_Provider(pContext)->Context, &FileOp, ProcessId, ThreadId, FileName)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_FileOp _mcgen_PASTE2(McTemplateU0xxz_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "CreateOp"
//
#define EventEnabledCreateOp() _mcgen_EVENT_BIT_SET(Forensics_Collector_ProviderEnableBits, 0)
#define EventEnabledCreateOp_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_Forensics_Collector_Provider(pContext)->EnableBits, 0)

//
// Event write macros for event "CreateOp"
//
#define EventWriteCreateOp(ProcessId, ThreadId, EPROCESS, ParentProcessId, CreateDestroy, CommandLine, ImageFileName) \
        MCGEN_EVENT_ENABLED(CreateOp) \
        ? _mcgen_TEMPLATE_FOR_CreateOp(&ForesicsCollector_Context, &CreateOp, ProcessId, ThreadId, EPROCESS, ParentProcessId, CreateDestroy, CommandLine, ImageFileName) : 0
#define EventWriteCreateOp_AssumeEnabled(ProcessId, ThreadId, EPROCESS, ParentProcessId, CreateDestroy, CommandLine, ImageFileName) \
        _mcgen_TEMPLATE_FOR_CreateOp(&ForesicsCollector_Context, &CreateOp, ProcessId, ThreadId, EPROCESS, ParentProcessId, CreateDestroy, CommandLine, ImageFileName)
#define EventWriteCreateOp_ForContext(pContext, ProcessId, ThreadId, EPROCESS, ParentProcessId, CreateDestroy, CommandLine, ImageFileName) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, CreateOp) \
        ? _mcgen_TEMPLATE_FOR_CreateOp(&(pContext)->Context, &CreateOp, ProcessId, ThreadId, EPROCESS, ParentProcessId, CreateDestroy, CommandLine, ImageFileName) : 0
#define EventWriteCreateOp_ForContextAssumeEnabled(pContext, ProcessId, ThreadId, EPROCESS, ParentProcessId, CreateDestroy, CommandLine, ImageFileName) \
        _mcgen_TEMPLATE_FOR_CreateOp(&_mcgen_CheckContextType_Forensics_Collector_Provider(pContext)->Context, &CreateOp, ProcessId, ThreadId, EPROCESS, ParentProcessId, CreateDestroy, CommandLine, ImageFileName)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_CreateOp _mcgen_PASTE2(McTemplateU0xxxxtzz_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "LoadOp"
//
#define EventEnabledLoadOp() _mcgen_EVENT_BIT_SET(Forensics_Collector_ProviderEnableBits, 0)
#define EventEnabledLoadOp_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_Forensics_Collector_Provider(pContext)->EnableBits, 0)

//
// Event write macros for event "LoadOp"
//
#define EventWriteLoadOp(ProcessId, ThreadId, FullImageName) \
        MCGEN_EVENT_ENABLED(LoadOp) \
        ? _mcgen_TEMPLATE_FOR_LoadOp(&ForesicsCollector_Context, &LoadOp, ProcessId, ThreadId, FullImageName) : 0
#define EventWriteLoadOp_AssumeEnabled(ProcessId, ThreadId, FullImageName) \
        _mcgen_TEMPLATE_FOR_LoadOp(&ForesicsCollector_Context, &LoadOp, ProcessId, ThreadId, FullImageName)
#define EventWriteLoadOp_ForContext(pContext, ProcessId, ThreadId, FullImageName) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, LoadOp) \
        ? _mcgen_TEMPLATE_FOR_LoadOp(&(pContext)->Context, &LoadOp, ProcessId, ThreadId, FullImageName) : 0
#define EventWriteLoadOp_ForContextAssumeEnabled(pContext, ProcessId, ThreadId, FullImageName) \
        _mcgen_TEMPLATE_FOR_LoadOp(&_mcgen_CheckContextType_Forensics_Collector_Provider(pContext)->Context, &LoadOp, ProcessId, ThreadId, FullImageName)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_LoadOp _mcgen_PASTE2(McTemplateU0xxz_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "ObjectOp"
//
#define EventEnabledObjectOp() _mcgen_EVENT_BIT_SET(Forensics_Collector_ProviderEnableBits, 0)
#define EventEnabledObjectOp_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_Forensics_Collector_Provider(pContext)->EnableBits, 0)

//
// Event write macros for event "ObjectOp"
//
#define EventWriteObjectOp(ProcessId, ThreadId, KernelUsermode, Handle, OperationType, DesiredAccess, OperationMode) \
        MCGEN_EVENT_ENABLED(ObjectOp) \
        ? _mcgen_TEMPLATE_FOR_ObjectOp(&ForesicsCollector_Context, &ObjectOp, ProcessId, ThreadId, KernelUsermode, Handle, OperationType, DesiredAccess, OperationMode) : 0
#define EventWriteObjectOp_AssumeEnabled(ProcessId, ThreadId, KernelUsermode, Handle, OperationType, DesiredAccess, OperationMode) \
        _mcgen_TEMPLATE_FOR_ObjectOp(&ForesicsCollector_Context, &ObjectOp, ProcessId, ThreadId, KernelUsermode, Handle, OperationType, DesiredAccess, OperationMode)
#define EventWriteObjectOp_ForContext(pContext, ProcessId, ThreadId, KernelUsermode, Handle, OperationType, DesiredAccess, OperationMode) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, ObjectOp) \
        ? _mcgen_TEMPLATE_FOR_ObjectOp(&(pContext)->Context, &ObjectOp, ProcessId, ThreadId, KernelUsermode, Handle, OperationType, DesiredAccess, OperationMode) : 0
#define EventWriteObjectOp_ForContextAssumeEnabled(pContext, ProcessId, ThreadId, KernelUsermode, Handle, OperationType, DesiredAccess, OperationMode) \
        _mcgen_TEMPLATE_FOR_ObjectOp(&_mcgen_CheckContextType_Forensics_Collector_Provider(pContext)->Context, &ObjectOp, ProcessId, ThreadId, KernelUsermode, Handle, OperationType, DesiredAccess, OperationMode)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_ObjectOp _mcgen_PASTE2(McTemplateU0xxtxzxt_, MCGEN_EVENTWRITETRANSFER)
...
//
// Function for template "Object Manager" (and possibly others).
// This function is for use by MC-generated code and should not be used directly.
//
#ifndef McTemplateU0xxtxzxt_def
#define McTemplateU0xxtxzxt_def
ETW_INLINE
ULONG
_mcgen_PASTE2(McTemplateU0xxtxzxt_, MCGEN_EVENTWRITETRANSFER)(
    _In_ PMCGEN_TRACE_CONTEXT Context,
    _In_ PCEVENT_DESCRIPTOR Descriptor,
...
{
#define McTemplateU0xxtxzxt_ARGCOUNT 7

    EVENT_DATA_DESCRIPTOR EventData[McTemplateU0xxtxzxt_ARGCOUNT + 1];
    ...
    return McGenEventWrite(Context, Descriptor, NULL, McTemplateU0xxtxzxt_ARGCOUNT + 1, EventData);
}
#endif // McTemplateU0xxtxzxt_def

//
// Function for template "Create Process" (and possibly others).
// This function is for use by MC-generated code and should not be used directly.
//
#ifndef McTemplateU0xxxxtzz_def
#define McTemplateU0xxxxtzz_def
ETW_INLINE
ULONG
_mcgen_PASTE2(McTemplateU0xxxxtzz_, MCGEN_EVENTWRITETRANSFER)(
    _In_ PMCGEN_TRACE_CONTEXT Context,
    _In_ PCEVENT_DESCRIPTOR Descriptor,
    _In_ const unsigned __int64  _Arg0,
    _In_ const unsigned __int64  _Arg1,
...
{
#define McTemplateU0xxxxtzz_ARGCOUNT 7

    EVENT_DATA_DESCRIPTOR EventData[McTemplateU0xxxxtzz_ARGCOUNT + 1];
    ...
    return McGenEventWrite(Context, Descriptor, NULL, McTemplateU0xxxxtzz_ARGCOUNT + 1, EventData);
}
#endif // McTemplateU0xxxxtzz_def

//
// Function for template "Filter Manager" (and possibly others).
// This function is for use by MC-generated code and should not be used directly.
//
...
ETW_INLINE
ULONG
_mcgen_PASTE2(McTemplateU0xxz_, MCGEN_EVENTWRITETRANSFER)(
    _In_ PMCGEN_TRACE_CONTEXT Context,
    _In_ PCEVENT_DESCRIPTOR Descriptor,
    _In_ const unsigned __int64  _Arg0,
    _In_ const unsigned __int64  _Arg1,
...
#define McTemplateU0xxz_ARGCOUNT 3
    ...
    return McGenEventWrite(Context, Descriptor, NULL, McTemplateU0xxz_ARGCOUNT + 1, EventData);
}
#endif // McTemplateU0xxz_def

//
// Function for template "Registry Operation" (and possibly others).
// This function is for use by MC-generated code and should not be used directly.
//
#ifndef McTemplateU0xxzx_def
#define McTemplateU0xxzx_def
ETW_INLINE
ULONG
_mcgen_PASTE2(McTemplateU0xxzx_, MCGEN_EVENTWRITETRANSFER)(
    _In_ PMCGEN_TRACE_CONTEXT Context,
    _In_ PCEVENT_DESCRIPTOR Descriptor,
    _In_ const unsigned __int64  _Arg0,
    _In_ const unsigned __int64  _Arg1,
...
{
#define McTemplateU0xxzx_ARGCOUNT 4

    EVENT_DATA_DESCRIPTOR EventData[McTemplateU0xxzx_ARGCOUNT + 1];
    ...
    return McGenEventWrite(Context, Descriptor, NULL, McTemplateU0xxzx_ARGCOUNT + 1, EventData);
}
#endif // McTemplateU0xxzx_def
...
#define MSG_Forensics_Collector_Provider_event_1_message 0xB0010001L
#define MSG_Forensics_Collector_Provider_event_2_message 0xB0010002L
#define MSG_Forensics_Collector_Provider_event_3_message 0xB0010003L
#define MSG_Forensics_Collector_Provider_event_4_message 0xB0010004L
#define MSG_Forensics_Collector_Provider_event_5_message 0xB0010005L
